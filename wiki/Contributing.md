...
Click **Code → Codespaces → Create codespace on main** on the [repo page](https://github.com/cedbossneo/mowglinext). You get a full ROS2 Jazzy environment with Nav2, Gazebo, and all dev tools — ready in minutes, no local setup.
