...
private:
  ...
  void create_publishers()
  {
    ...
    // RELIABLE QoS for sensor data — FusionCore subscribes RELIABLE and
    // refuses BEST_EFFORT publishers. Slight bandwidth cost is acceptable
    // for single-host setup; ensures no IMU/odom samples are dropped.
