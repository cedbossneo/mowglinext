...
export class MowingFeatureBase extends MowingFeature implements Feature<Polygon> {
    ...
    transpose(points: Point32[], offsetX: number, offsetY: number, datum: [number,number,number], transposeFn: TransposeFn) {
...
export class MapAreaFeature extends MowingFeatureBase {
    ...
    setArea(area: MapArea, offsetX: number, offsetY: number, datum: [number,number,number], transposeFn: TransposeFn) {
        this.area = area;
