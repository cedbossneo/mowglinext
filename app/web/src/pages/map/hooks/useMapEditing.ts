...
import { MowingFeature, MowingAreaFeature, MowingFeatureBase, NavigationFeature, ObstacleFeature } from "@mowglinext/common";
import {MowingAreaEdit} from "../utils/types";
